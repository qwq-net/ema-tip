    ...
    return (
      <div className="relative">
        <select
          ref={ref}
          className={cn(
            'focus:ring-primary/20 focus:border-primary rounded-control w-full appearance-none border border-gray-300 bg-white px-3 py-2 text-base transition focus:ring-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm',
            className
          )}
          {...props}
        >
